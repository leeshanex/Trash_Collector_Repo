    ...
    public partial class NewCustomerProperties : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "AspNetRoles",
                keyColumn: "Id",
                keyValue: "e1f7ce49-6c5d-4452-8d63-9ae78568525e");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DayOfWeekPickUp = table.Column<string>(nullable: true),
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "e1f7ce49-6c5d-4452-8d63-9ae78568525e", "58a2baa9-dc83-48be-9ccd-f5e7decdd8cf", "Admin", "ADMIN" });
        }
    }
}
